...
export default function HomeScreen() {
  ...
  const fetchUpcomingAppointment = async () => {
    ...
    try {
      // prefer userId from auth context, fall back to stored userData
      ...
      const response = await api.get(`/appointments?userId=${effectiveUserId}`);
  ...
  const fetchNextMedicine = async () => {
    ...
    try {
      ...
      const storedId = userDataString ? JSON.parse(userDataString).id : null;
      const effectiveUserId = userId || storedId;
      ...
      const response = await api.get(`/medications/today/${effectiveUserId}`);
          ...
          {isLoadingAppointment ? (
            ...
            <View style={styles.appointmentCard}>
              ...
              <View style={{ flex: 1, marginLeft: 10 }}>
                ...
                <Text style={styles.appointmentDetails}>
                  {new Date(upcomingAppointment.appointmentTime).toLocaleDateString(
                    "en-US",
                    {
                      weekday: "long",
                      month: "long",
          ...
          {isLoadingMedicine ? (
            ...
            >
              ...
              <View>
                ...
                <Text style={styles.appointmentDetails}>
                  {new Date(nextMedicine.scheduledTime).toLocaleTimeString(
                    "en-US",
                    {
                      hour: "numeric",
                      minute: "2-digit",
