...
export default function AddMedicationScreen() {
  ...
  const handleSave = async () => {
    try {
      ...
      const colors = ["#63b0a3ff", "#2f6591ff", "#a76e1aff", "#9e2d53ff", "#9C27B0"];
          ...
          <View style={styles.section}>
            ...
            >
              <View style={styles.dateIconContainer}>
                <Ionicons name="calendar" size={20} color="#63b0a3ff" />
              </View>
                ...
                {form.times.map((time, index) => (
                  ...
                  >
                    <View style={styles.timeIconContainer}>
                      <Ionicons name="time-outline" size={20} color="#63b0a3ff" />
                    </View>
              ...
              <View style={styles.switchRow}>
                <View style={styles.switchLabelContainer}>
                  <View style={styles.iconContainer}>
                    <Ionicons name="notifications" size={20} color="#63b0a3ff" />
                  </View>
                  <View>
          ...
          <View style={styles.section}>
            <View style={styles.card}>
              <View style={styles.switchRow}>
                <View style={styles.switchLabelContainer}>
                  <View style={styles.iconContainer}>
                    <Ionicons name="reload" size={20} color="#63b0a3ff" />
                  </View>
                  <View>
